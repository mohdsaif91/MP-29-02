...
//                session.setAttribute("abcd", "You Haven't Signed In ! ");
                    ...
                    String query = "select productid,id,companyname,price,packaging,quantity,image,productname from " + username + " where show='" + ab + "'";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (deletecate == null) {
                ...
                String query = "update maincompany set companyimagename='" + partimagename + "',companyname='" + comString + "' where id=" + ogid + "";
                con = ConnectionClass.getConnection();
                ps = con.prepareStatement(query);
                ps.executeUpdate();
                con.close();
