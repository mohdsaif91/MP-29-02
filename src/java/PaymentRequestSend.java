    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id != null && payed.equals("no")) {
            try {
                ...
                String ogid = id.trim();
                String querys = "update adminordertable set paymentdoen='yes',yyyy_mm_dd='" + date + "' where id='" + ogid + "'";
            ...
            List<PaymentPojo> collectPaymentList = payList.stream()
                    .filter((PaymentPojo papo) -> papo.id.equals(ogid)).collect(Collectors.toList());
            System.out.println("------------------------------------------------------------OUTTTTTTT");
            System.out.println(payList.size() + "<-size------------------------------------------------------------OUTTTTTTT");
            payList.forEach(s -> {
                System.out.println("------------------------------------------------------------");
...
//    ---------------------------------------------------
            ...
            String query = " INSERT INTO public.packagepojo(id, address1, address2, brandname, cardholdename, cardnumber,"
                    ...
                    + "    VALUES ('" + id + "', '" + address1 + "','" + address2 + "','" + brandname + "','" + cardHoldeName + "','" + cardNumber + "',"
                    + "            '" + city + "','" + companyname + "','" + country + "'," + cvvNumber + ",'" + emailid + "','" + expiryDate + "','" + firstname + "',"
                    + "            '" + genericname + "', '" + imagename + "','" + lastname + "','" + mobilenum + "','" + packaging + "','" + paymentdoen + "',"
                    + "            '" + paymentoption + "','" + productid + "','" + productprice + "','" + quantity + "','" + state + "',"
