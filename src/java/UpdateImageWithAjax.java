...
import Modal.UpdateAndDeletePojo;
import Modal.subcategorypojo;
import java.io.File;
...
public class UpdateImageWithAjax extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "update " + ogname + "  set company='" + companyname + "'"
                    + ",genericname='" + genericname + "',imagename='" + partimagename + "',brandname='" + brandname + "'"
                    + ",mdeidescription='" + description + "',productprice='" + productprice + "',packaging='" + packaging + "' where id=" + ogid + "";
