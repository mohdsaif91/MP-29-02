...
import Modal.AllDataPojo;
import Modal.PaymentPojo;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (paymentName.equals("gpay") || paymentName.equals("zelle") || paymentName.equals("paypal")) {
                ...
                List<adminordertable> singledata = copylist.stream().filter((adminordertable op) -> op.id.contains(oid)).collect(Collectors.toList());
                con.close();
                ...
                request.setAttribute("paymentinfoq", paylist);
                System.out.println("set the eq param");
                List<adminordertable> singledata = copylist.
                        stream().filter((adminordertable op) -> op.id.contains(oid)).collect(Collectors.toList());
                request.setAttribute("order", singledata);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (username.equals("user") && password.equals("pass")) {
                ...
                String query = "select username,password from admintablecredentials where username='" + username + "' and"
                        + " password='" + password + "'";
                con = ConnectionClass.getConnection();
                ps = con.prepareStatement(query);
                rs = ps.executeQuery();
                ...
                if (rs.next()) {
                    ...
                    String uquery = "select * from usernameandpassword where useraname='" + username + "' and password='" + password + "'";
