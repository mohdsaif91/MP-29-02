...
//    String username, int userid, int productid, String brandname,
//            String companyname, int quntity
...
// outgoing message information
        ...
        for (int i=0;i<=1;i++) {
            try {
                sendHtmlEmail(host, port, myaccount, passwordinside, recipeantList.get(i), subjectList.get(i), message);
