...
public class shop extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "select id,genericname,imagename,mdeidescription,productprice,packaging from " + ogstring + " where company='" + ogtabname + "' and brandname='" + ogbrandname + "'";
