    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
                            <div class="site-block-cover-content text-center">
                                ...
                                <h1>Welcome To Matrix Pharma</h1>
                                <p>
        ...
        <script>
                                    ...
                                    $('.buy-nowo').click(function () {
                                        var fg = $(this).index();
                                        var id = document.getElementsByClassName('getid')[fg].innerHTML;
                                        var tabnam = document.getElementsByClassName('ko')[fg].innerHTML;
