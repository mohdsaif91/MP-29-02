                            ...
                            <div class="row panel panel-default align-items-center" style="opacity: 0.8;">
                                ...
                                <div class="row" id="creditcardhide"  style="padding-left: 40px;">
                                    ...
                                    <div class="col-6 col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="namecreditcard" placeholder="1234567890" required="">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-6 col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="creditcardnum" placeholder="1234567890" required="">
                                        <div class="invalid-feedback">
                                            Credit card number invalid. 
                                        </div>
                                    </div>
                                    <div class="col-6 col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="cvvnumber" placeholder="239"  required="">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-6 col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="expiryDate" placeholder="08/2024" required="">
                                        <div class="invalid-feedback">
                                            Expiry Date invalid
                                        </div>
                                    </div>
                                    <div class="col-6 col-md-6 mb-3">
                                        <label for="lastName">Email Id</label>
                                        <input type="text" class="form-control" id="creditemail" placeholder="08/2024"  required="">
                                        <div class="invalid-feedback">
                                            Expiry Date invalid
                                        </div>
                                    </div>
                                    <div class="col-6 col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="creditmobile" placeholder="08/2024" value="" required="">
                                        <div class="invalid-feedback">
                                            Expiry Date invalid
                                        </div>
                                    </div>
